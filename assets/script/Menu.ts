...
export default class NewClass extends cc.Component {
    ...
    start() {
        ...
        cc.find("Canvas/LoginButton").getComponent(cc.Button).clickEvents.push(log_in_btn);
        ...
        cc.find("Canvas/RegisterButton").getComponent(cc.Button).clickEvents.push(sign_up_btn);
